...
def delete_selected_from_flickr(modeladmin, request, queryset):
    """
...
#             queryset.delete()
    ...
    return TemplateResponse(request, modeladmin.delete_selected_confirmation_template or [
        "admin/%s/%s/delete_selected_from_flickr_confirmation.html" % (app_label, opts.model_name),
        "admin/%s/delete_selected_from_flickr_confirmation.html" % app_label,
        "admin/delete_selected_from_flickr_confirmation.html"
